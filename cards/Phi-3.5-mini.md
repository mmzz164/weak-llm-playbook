...
- [inst_ja] meta_negation: {'禁止を守る': 9, '禁止を破る(set使用)': 6} (stability 0.6)
- [io] io_missing_field: {'値を発明/他': 11, 'JSON不成立': 4} (stability 0.73)
- [io] io_csv_header: {'ヘッダなし': 8, 'ヘッダあり': 7} (stability 0.53)
- [io] txt_name_order: {'姓-名(Yamada Taro)': 2, '名-姓(Taro Yamada)': 2, '他/ローマ字なし': 1} (stability 0.4)
- [io] txt_clarify: {'手順/コマンドを答える': 10, '逆質問(不足を指摘)': 4, '架空データで進める': 1} (stability 0.67)
